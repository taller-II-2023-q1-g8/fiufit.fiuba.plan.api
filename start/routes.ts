...
Route.group(() => {
  Route.group(() => {
    ...
    Route.get('/plans/:id/block', 'PlansController.isBlockedPlan') // /api/v1/plans/:id/block
    Route.post('/plans/:id/block', 'PlansController.setBlockedPlan') // /api/v1/plans/:id/block
